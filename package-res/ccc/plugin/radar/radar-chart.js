...
/**
 * RadarChart is the main class for generating radar charts.
 */
def
.type('pvc.RadarChart', pvc.BaseChart)
.add({
    _axisClassByType: {
    ...
    _createPlotsInternal: function() {
        this._addPlot(new pvc.visual.RadarPlot(this));
    },
    ...
    _createContentPanel: function(parentPanel, contentOptions) {
        // TODO: move these to the radar plot?
    ...
    _createContent: function(parentPanel, contentOptions) {
        ...
        contentOptions.scenes = def.getPath(this.options, 'radar.scenes');
